...
main_event="$base_dir/_Hack.event"

target_rom="$base_dir/_Hack.gba"
target_ups="$base_dir/_Hack.ups" # unused, but kept for symmetry with MAKE HACK_full.cmd
target_sym="$base_dir/_Hack.sym"
