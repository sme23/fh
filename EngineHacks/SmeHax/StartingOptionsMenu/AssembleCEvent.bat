...
SET incl=U:\Projects\FE-CLib\include
SET lyn="C:\devkitPro\lyn.exe"

@rem compile into an object file
%gcc% -mcpu=arm7tdmi -mabi=aapcs -mthumb -mthumb-interwork -fomit-frame-pointer -ffast-math -fno-toplevel-reorder -mlong-calls -I %incl% -O2 -c %1 -o "%~n1.o"
